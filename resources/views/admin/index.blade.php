    ...
    <div class="container">
                        ...
                        <div class="collapsible-body">
                            <div class="row mb-0">
                                <form action="{{route('admins.search')}}" method="POST">
                                    ...
                                    <br>
                                    <button type="submit"
                                            class="btn waves-effect waves-light col s6 offset-s3 m4 offset-m4 l2 xl2">
                                        Search
                                    </button>
                                </form>
                            </div>
        ...
        <div class="row">
            ...
            <div class="card col s12 m12 l12 xl12">
                        ...
                        <div class="row">
                            ...
                            <table class="responsive-table col s12 m12 l12 xl12">
                                ...
                                @else
                                    ...
                                    <tr>
                                        <td colspan="5"><h6 class="grey-text text-darken-2 center">No Admins Found!</h6>
                                        </td>
                                    </tr>
                                @endif
                ...
                @else
                    <h4 style="color: red;text-align: center">ยูสเซอร์นี้ไม่มีสิทธิ์ในการแก้ไขแอดมิน</h4>
