...
@section('content')
<div class="container">
    <h4 class="grey-text text-darken-2 center">Candidate Management</h4>
                    ...
                    <div class="row mb-0">
                        <form action="{{route('candidates.search')}}" method="POST">
                            ...
                            <div class="input-field col s12 m6 l5 xl6">
                                ...
                                <label for="search">Search Candidate</label>
    ...
    <div class="row">
        ...
        <div class="card col s12 m12 l12 xl12">
            <div class="card-content">
                <div class="row">
                    <h5 class="pl-15 grey-text text-darken-2">Candidate List</h5>
                            ...
                            @if($candidates->count())
                                @foreach($candidates as $candidate)
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>
                                            <img class="emp-img" src="{{asset('storage/candidates/'.$candidate->picture)}}">
                                        </td>
                                        <td>{{$candidate->first_name}} {{$candidate->last_name}}</td>
                                        <td>
                                            <div class="row mb-0">
                                                <div class="col">
                                                    <a href="{{route('candidates.edit',$candidate->id)}}" class="btn btn-floating btn-small waves=effect waves-light orange"><i class="material-icons">mode_edit</i></a>
                                                </div>
                                                <div class="col">
                                ...
                                @else
                                    ...
                                    <tr>
                                        <td colspan="5"><h6 class="grey-text text-darken-2 center">Not Found!</h6></td>
                                    </tr>
                                @endif
