...
@section('content')
<div class="container">
    <h4 class="grey-text text-darken-2 center">จัดการตำแหน่ง</h4>
    
    {{-- Include the searh component with with title and route --}}
    @component('sys_mg.inc.search',['title' => 'แผนก' , 'route' => 'departments.search'])
    @endcomponent
    ...
    <div class="row">
        ...
        <div class="card col s12 m12 l12 xl12">
            <div class="card-content">
                <div class="row">
                    <h5 class="pl-15 grey-text text-darken-2">ตำแหน่ง</h5>
