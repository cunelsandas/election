...
Route::post('/systemsettings/search','SystemsettingsController@search')->name('systemsettings.search');

Route::resource('/customerinfos','CustomerinfosController');
Route::post('/customerinfos/search','CustomerinfosController@search')->name('systemsettings.search');

Route::resource('/constituencies','ConstituenciesController');
Route::post('/constituencies/search','ConstituenciesController@search')->name('systemsettings.search');

/**
 *  States Route(s)
 */
Route::resource('/candidates','EmployeesController');

Route::post('candidates/search','EmployeesController@search')->name('employees.search');
